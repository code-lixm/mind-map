/**
 * MindMap 组件文案字典
 * 替代 vue-i18n，提供默认中文文案，支持通过 props 覆盖
 */
...
export const defaultLocaleText: LocaleText = {
  ...
  setting: {
    ...
    changeRichTextTip2: '切换为富文本模式？',
    changeRichTextTip3: '切换为非富文本模式？',
  ...
  export: {
    ...
    addFooterTextPlaceholder: '比如：云深科技有限公司',
    desc: '说明',
    options: '选项',
    hideTaskNodes: '隐藏任务节点',
  ...
  mouseAction: {
    tip1: '当前：左键拖动画布，右键框选节点<br/>任何模式：按住空格(space) + 鼠标左键拖拽画布',
    tip2: '当前：左键框选节点，右键拖动画布<br/>任何模式：按住空格(space) + 鼠标左键拖拽画布',
  },
  search: {
...
/**
 * 合并自定义文案
 * @param customText 自定义文案
 * @returns 合并后的完整文案
 */
export function mergeLocaleText(
  customText?: Partial<LocaleText>,
): LocaleText {
  if (!customText) {
  ...
  return {
    baseStyle: { ...defaultLocaleText.baseStyle, ...customText.baseStyle },
    setting: { ...defaultLocaleText.setting, ...customText.setting },
    color: { ...defaultLocaleText.color, ...customText.color },
    contextmenu: { ...defaultLocaleText.contextmenu, ...customText.contextmenu },
    count: { ...defaultLocaleText.count, ...customText.count },
    dialog: { ...defaultLocaleText.dialog, ...customText.dialog },
    export: { ...defaultLocaleText.export, ...customText.export },
    fullscreen: { ...defaultLocaleText.fullscreen, ...customText.fullscreen },
    demonstrate: { ...defaultLocaleText.demonstrate, ...customText.demonstrate },
    import: { ...defaultLocaleText.import, ...customText.import },
    navigatorToolbar: { ...defaultLocaleText.navigatorToolbar, ...customText.navigatorToolbar },
    nodeHyperlink: { ...defaultLocaleText.nodeHyperlink, ...customText.nodeHyperlink },
    nodeIcon: { ...defaultLocaleText.nodeIcon, ...customText.nodeIcon },
    nodeImage: { ...defaultLocaleText.nodeImage, ...customText.nodeImage },
    nodeNote: { ...defaultLocaleText.nodeNote, ...customText.nodeNote },
    nodeTag: { ...defaultLocaleText.nodeTag, ...customText.nodeTag },
    outline: { ...defaultLocaleText.outline, ...customText.outline },
    scale: { ...defaultLocaleText.scale, ...customText.scale },
    shortcutKey: { ...defaultLocaleText.shortcutKey, ...customText.shortcutKey },
    strusture: { ...defaultLocaleText.strusture, ...customText.strusture },
    style: { ...defaultLocaleText.style, ...customText.style },
    theme: { ...defaultLocaleText.theme, ...customText.theme },
    toolbar: { ...defaultLocaleText.toolbar, ...customText.toolbar },
    edit: { ...defaultLocaleText.edit, ...customText.edit },
    mouseAction: { ...defaultLocaleText.mouseAction, ...customText.mouseAction },
    search: { ...defaultLocaleText.search, ...customText.search },
    nodeIconSidebar: { ...defaultLocaleText.nodeIconSidebar, ...customText.nodeIconSidebar },
    formulaSidebar: { ...defaultLocaleText.formulaSidebar, ...customText.formulaSidebar },
    richTextToolbar: { ...defaultLocaleText.richTextToolbar, ...customText.richTextToolbar },
    other: { ...defaultLocaleText.other, ...customText.other },
    sourceCodeEdit: { ...defaultLocaleText.sourceCodeEdit, ...customText.sourceCodeEdit },
    attachment: { ...defaultLocaleText.attachment, ...customText.attachment },
    annotation: { ...defaultLocaleText.annotation, ...customText.annotation },
    nodeOuterFrame: { ...defaultLocaleText.nodeOuterFrame, ...customText.nodeOuterFrame },
    nodeTagStyle: { ...defaultLocaleText.nodeTagStyle, ...customText.nodeTagStyle },
